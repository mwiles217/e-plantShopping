...
function ProductList({ onHomeClick }) {
    ...
    const handleAddToCart = (product) => {
      ...
      const addToCartDisabled=(product)=>{

        return false;
        const itemToCheck = addedToCart.find(item => item.name === product.name);
        if(itemToCheck){
            return "true";
        }
        return "false";
            ...
            <div className="navbar" style={styleObj}>
                <div className="tag">
                    <div className="luxury">
                        ...
                        <a href="/" onClick={(e) => handleHomeClick(e)}>
                            <div>
                                <h3 style={{ color: 'white' }}>Emberleaf Gardnes</h3>
                                <i style={{ color: 'white' }}>Cultivate life, beauty, and green connection.</i>
                            </div>
                        </a>
                    </div>
                ...
                <div style={styleObjUl}>
                    ...
                    <div> <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}><h1 className='cart'>
                        ...
                        <text x="125" y="155" fill="white">{totalItems}</text>
